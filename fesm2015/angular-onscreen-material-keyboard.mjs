...
import { InjectionToken, EventEmitter, Component, ChangeDetectionStrategy, Inject, Input, Output, ViewChild, HostBinding, HostListener, LOCALE_ID, Injectable, Optional, SkipSelf, ViewChildren, Directive, Self, Pipe, NgModule } from '@angular/core';
...
MatKeyboardService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: MatKeyboardService, deps: [{ token: i1$2.Overlay }, { token: i2$1.LiveAnnouncer }, { token: LOCALE_ID }, { token: MAT_KEYBOARD_LAYOUTS }, { token: MatKeyboardService, optional: true, skipSelf: true }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: MatKeyboardService, decorators: [{
        ...
        return [{ type: i1$2.Overlay }, { type: i2$1.LiveAnnouncer }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_ID]
...
MatKeyboardDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: MatKeyboardDirective, deps: [{ token: i0.ElementRef }, { token: MatKeyboardService }, { token: i2$2.NgControl, optional: true, self: true }], target: i0.ɵɵFactoryTarget.Directive });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: MatKeyboardDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: MatKeyboardService }, { type: i2$2.NgControl, decorators: [{
                        type: Optional
                    }, {
                        type: Self
                    }] }];
...
export { HIDE_ANIMATION, KEYBOARD_ICONS, KeyboardAnimationState, KeyboardAnimationTransition, KeyboardClassKey, KeyboardModifier, MAT_KEYBOARD_DEADKEYS, MAT_KEYBOARD_LAYOUTS, MatKeyboardComponent, MatKeyboardConfig, MatKeyboardContainerComponent, MatKeyboardDirective, MatKeyboardKebabCasePipe, MatKeyboardKeyComponent, MatKeyboardModule, MatKeyboardRef, MatKeyboardService, SHOW_ANIMATION, VALUE_NEWLINE, VALUE_SPACE, VALUE_TAB, _applyAvailableLayouts, _applyConfigDefaults, keyboardDeadkeys, keyboardLayouts };
//# sourceMappingURL=angular-onscreen-material-keyboard.mjs.map
