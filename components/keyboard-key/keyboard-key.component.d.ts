...
export declare class MatKeyboardKeyComponent implements OnInit, OnDestroy {
    ...
    private _isTextarea;
    static ɵfac: i0.ɵɵFactoryDeclaration<MatKeyboardKeyComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<MatKeyboardKeyComponent, "mat-keyboard-key", never, { "key": "key"; "icon": "icon"; "active": "active"; "pressed": "pressed"; "input": "input"; "control": "control"; }, { "genericClick": "genericClick"; "enterClick": "enterClick"; "bkspClick": "bkspClick"; "capsClick": "capsClick"; "altClick": "altClick"; "shiftClick": "shiftClick"; "spaceClick": "spaceClick"; "tabClick": "tabClick"; "keyClick": "keyClick"; }, never, never, false>;
}
